...
<!-- Prompts to answer once done:
     - Did I ever nearly send an internal note as a reply? What's my habit to prevent it?
     - When does pausing the SLA clock (waiting on user) genuinely apply vs feel like gaming it?
     - What makes a resolution summary good enough that the ticket doesn't reopen? -->
